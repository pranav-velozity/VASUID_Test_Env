      ...
      for (let i = 0; i < order.length; i++) {
        ...
        dots += `
          <g>
            ...
            ${(USE_SPINE_ICONS && spineIcon(id)) ? `<g transform="translate(${xi - 12},4)">${spineIcon(id)}</g>` : `<text x="${xi}" y="7" text-anchor="middle" font-size="12" font-weight="600" fill="rgba(55,65,81,0.70)">${label(id)}</text>`}
          </g>
        `;
      }
